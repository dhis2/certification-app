...
export class TemplatesController {
  ...
  async update(
    ...
    const template = await this.templatesService.update(id, dto, user.sub);
    return TemplateResponseDto.fromEntity(template, true);
  }
  ...
  async delete(
    ...
    await this.templatesService.delete(id, user.sub);
  }
  ...
  async publish(
    ...
    const template = await this.versioningService.publish(id, user.sub);
    return TemplateResponseDto.fromEntity(template, true);
  }
