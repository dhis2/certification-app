...
export class AuditController {
  ...
  @ApiOperation({
    ...
    description: 'Validates hash chain integrity and HMAC signatures.',
  })
  ...
  @ApiOperation({
    ...
    description: 'Returns HMAC key configuration status.',
  })
  @ApiResponse({
    status: 200,
    schema: {
  ...
  @ApiOperation({
    ...
    description: 'Returns the current retention policy configuration.',
  })
  ...
  @ApiOperation({
    ...
    description: 'Generates a compliance report for audit log retention.',
  })
