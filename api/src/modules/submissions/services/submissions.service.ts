...
export class SubmissionsService {
    ...
    await this.auditService.log(
      {
        ...
        entityId: saved.id,
        entityName: implementation.name,
  ...
  async saveResponses(
    ...
    const entityName = await this.resolveImplementationName(
  ...
  private async resolveImplementationName(
    implementationId: string,
  ): Promise<string | null> {
    const impl = await this.implementationRepo.findOne({
