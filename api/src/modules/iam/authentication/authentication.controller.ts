...
import { type AuditContext } from 'src/modules/audit';
...
export class AuthenticationController {
  ...
  signIn(@Body() signInDto: SignInDto, @Req() req: Request) {
    return this.authService.signIn(signInDto, this.extractAuditContext(req));
  }
  ...
  async signOut(
    ...
    await this.authService.signOut(activeUser, this.extractAuditContext(req));
  }
