...
export const useAuditLogs = (filters: AuditLogFilters = {}): UseAuditLogsReturn => {
    const { entityType, eventType, actorId, actorEmail, action, startDate, endDate, first = DEFAULT_PAGE_SIZE, after } = filters
    ...
    const params = useMemo(
        ...
        [entityType, eventType, actorId, actorEmail, action, startDate, endDate]
    )
